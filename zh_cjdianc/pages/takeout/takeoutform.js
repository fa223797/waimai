...
Page({
    ...
    formSubmit: function(a) {
        ...
        if ("hdfk" == a.detail.value.radiogroup && "3" == i.is_hdfk && Number(g) <= 0) wx.showModal({
            ...
            if (console.log(n, d, r, l, c, "实付", u, "总优惠", h, "包装费", m, "运费", g, "满减金额", f, "新用户money", p, "优惠券", v, "红包", b, "折扣", D, "订单类型", k, S, M, N, "收货人", z, "收获电话", q, "收货地址", j, "留言", y, "sz", s, "配送时间", e, "餐具数量", w, T), 
