...
Page({
    ...
    spxqck: function(t) {
        var e = t.currentTarget.dataset.itemIndex, a = t.currentTarget.dataset.parentindex, o = this.data.dishes, s = this.data.cart_list.res, n = t.currentTarget.dataset.goodid, i = this.data.dishes[a].good[e], d = wx.getStorageSync("users").id, r = this.data.store_id;
    ...
    cartdec: function(t) {
        var e = t.currentTarget.dataset.itemIndex, a = t.currentTarget.dataset.parentindex, o = this.data.dishes, s = this.data.cart_list.res, n = t.currentTarget.dataset.goodid, i = this, d = this.data.dishes[a].good[e], r = wx.getStorageSync("users").id, c = this.data.store_id;
    ...
    cartadd: function(t) {
        var e = t.currentTarget.dataset.itemIndex, a = t.currentTarget.dataset.parentindex, o = this.data.dishes, s = t.currentTarget.dataset.goodid, n = this, i = this.data.dishes[a].good[e], d = wx.getStorageSync("users").id, r = this.data.store_id, c = "1" == getApp().xtxx.hygn && this.data.iszk && "0.00" != i.dn_hymoney ? 1 : 0;
    ...
    ggaddcart: function() {
        var t = this.data.itemIndex, e = this.data.parentindex, o = this.data.dishes, s = this, n = this.data.gginfo, a = wx.getStorageSync("users").id, i = this.data.gg, d = this.data.store_id, r = [], c = !0;
        for (var l in i) {
            var g = !1;
    ...
    hjfwy: function() {
        var e = this.data.store_id, a = this.data.tableid;
    ...
    addsp: function() {
        var e = this.data.oid, a = [], t = this.data.cart_list.res, o = this.data.cart_list.money;
        t.map(function(t) {
            if (0 < t.num) {
                var e = {};
    ...
    onLoad: function(t) {
        ...
        var l = this, a = l.data.store_id, g = l.data.tableid;
        this.setData({
            params: {
                store_id: a,
                type: "全部",
        ...
        app.util.request({
            ...
            success: function(t) {
                ...
                var a = t.data.store.time, o = t.data.store.time2, s = t.data.store.time3, n = t.data.store.time4, i = t.data.store.is_rest;
    ...
    maketel: function(t) {
        var e = this, a = this.data.store.tel, o = this.data.paytel;
